    ...
    <footer className="border-t border-border py-8 bg-background">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm text-foreground/70">
              Your AI-powered career coach for the tech industry.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/roadmap" className="text-foreground/70 hover:text-foreground">Career Roadmaps</Link></li>
              <li><Link to="/hackathons" className="text-foreground/70 hover:text-foreground">Hackathon Mentor</Link></li>
              <li><Link to="/challenges" className="text-foreground/70 hover:text-foreground">Coding Challenges</Link></li>
              <li><Link to="/coach" className="text-foreground/70 hover:text-foreground">AI Coach</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/guides" className="text-foreground/70 hover:text-foreground">Guides</Link></li>
              <li><Link to="/faq" className="text-foreground/70 hover:text-foreground">FAQ</Link></li>
              <li><Link to="/support" className="text-foreground/70 hover:text-foreground">Support</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-foreground/70">&copy; {new Date().getFullYear()} DevPathAI. All rights reserved.</p>
